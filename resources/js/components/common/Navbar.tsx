...
export default function Navbar() {
    ...
    return (
        <>
            <header
                ref={headerRef}
                className="flex flex-col lg:flex-row lg:gap-4 z-10 p-3 h-fit bg-neutral-700/95 border-b-5 border-b-neutral-800/50 backdrop-blur-md fixed w-full transition-all shadow-xl shadow-black/20"
            >
                <div
                    className={
