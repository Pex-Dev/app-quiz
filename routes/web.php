...
Route::post('/quiz/{quiz}/update',[QuizController::class,'update']) -> name('quiz.update') -> middleware(['auth','verified']);
...
Route::post('/quiz/{quiz}/delete',[QuizController::class,'destroy'])->name('quiz.destroy')->middleware('auth','verified');
